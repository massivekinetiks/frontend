...
import { Eye, EyeOff, Lock, Mail, Building2, Zap } from 'lucide-react';
        ...
        <div className="mt-12 grid grid-cols-1 gap-4">
          <div className="flex items-center p-4 bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Advanced defect detection and compliance checking</p>
            </div>
          </div>
          ...
          <div className="flex items-center p-4 bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div>
              <h3 className="font-medium text-gray-900">Multi-tenant Platform</h3>
              <p className="text-sm text-gray-600">Secure isolation for your organization</p>
            </div>
          </div>
        </div>
      </div>
